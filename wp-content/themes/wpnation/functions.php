...
function nation_include() {
	...
	wp_register_style( 'style-parent',	get_template_directory_uri() . '/style.css' );
...
if (class_exists('MultiPostThumbnails')) {
	...
	new MultiPostThumbnails(array(
        'label' => '5th Room Image',
        'id' => 'slider-image-5',
        'post_type' => 'rooms'
        )
	);
	new MultiPostThumbnails(array(
        'label' => '6th Room Image',
        'id' => 'slider-image-6',
        'post_type' => 'rooms'
        )
	);
	new MultiPostThumbnails(array(
        'label' => '7th Room Image',
        'id' => 'slider-image-7',
        'post_type' => 'rooms'
        )
	);
	new MultiPostThumbnails(array(
        'label' => '8th Room Image',
        'id' => 'slider-image-8',
        'post_type' => 'rooms'
        )
	);
	new MultiPostThumbnails(array(
        'label' => '9th Room Image',
        'id' => 'slider-image-9',
        'post_type' => 'rooms'
        )
	);
	new MultiPostThumbnails(array(
        'label' => '10th Room Image',
        'id' => 'slider-image-10',
        'post_type' => 'rooms'
        )
	);
	new MultiPostThumbnails(array(
        'label' => '11th Room Image',
        'id' => 'slider-image-11',
        'post_type' => 'rooms'
        )
	);
	new MultiPostThumbnails(array(
        'label' => '12th Room Image',
        'id' => 'slider-image-12',
        'post_type' => 'rooms'
        )
	);
	new MultiPostThumbnails(array(
        'label' => '13th Room Image',
        'id' => 'slider-image-13',
        'post_type' => 'rooms'
        )
	);
	new MultiPostThumbnails(array(
        'label' => '14th Room Image',
        'id' => 'slider-image-14',
        'post_type' => 'rooms'
        )
	);
	new MultiPostThumbnails(array(
        'label' => '15th Room Image',
        'id' => 'slider-image-15',
        'post_type' => 'rooms'
        )
	);
	new MultiPostThumbnails(array(
        'label' => '16th Room Image',
        'id' => 'slider-image-16',
        'post_type' => 'rooms'
        )
	);	
...
class main_menu_walker extends Walker_Nav_Menu {
	function start_lvl( &$output, $depth = 0, $args = array() ) {
		...
		if ($depth == 1) { $output .= "\n$indent<ul class='sub_menu2'>\n"; }
			...
			$output .= "\n$indent<ul class='sub_menu dropdown-menu'>\n";
		}
	}
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if($depth == 0) {$output .= $indent . '<li' . $value . $class_names .'>';}
			...
			if ($depth==0) { $output .= "<li class='submenu-arrow-wrap'><div class='top-submenu-arrow'></div></li>"; };
	   ...
	   if($depth != 0) { $description = $append = $prepend = "";}
			...
			$item_output .= '<a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"' . $attributes . '>';
