...
<?php } else { 
	if ( ! comments_open() ) {
?>
	<p class="nocomments"><?php _e('Comments are closed.','nation'); ?></p>
<?php } ?>
...
<?php } ?>
	...
	comment_form( array( 
		...
		'comment_notes_after' => "<button type='submit' id='submit-button'>".__("Post Comment","nation")." <span class='icon-envelope'></span></button>",
	) ); ?>	
