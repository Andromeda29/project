		...
		<div class="sixteen columns">
			...
			<div id="tabs-widget-wrap">
				<ul id="tabs">
					...
					<?php if ( isset($roomFeatures) && $roomFeatures != "" ) { ?><li><a href="#" name="#tab2"><?php _e('Features','nation'); ?></a></li><?php } ?>
					<?php if ( isset($roomPolicies) && $roomPolicies != "" ) { ?><li><a href="#" name="#tab3"><?php _e('Policies','nation'); ?></a></li><?php } ?>
