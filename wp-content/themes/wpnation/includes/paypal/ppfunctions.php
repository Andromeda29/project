...
function SetExpressCheckout($PayPalApiUsername, $PayPalApiPassword, $PayPalApiSignature, $PayPalMode, $amount, $version, $returnURL, $cancelURL, $roomTitle, $tax, $checkIn, $checkOut, $noItems, $currency) {
